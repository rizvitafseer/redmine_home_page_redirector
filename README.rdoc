= Home Page Redirector plugin for Redmine
...
Latest Tested for Redmine V5

Install to redmine/plugins directory. No migrations are needed. No configuration needed 
